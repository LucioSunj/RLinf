...
from Reinforcement_Learning.RLinf.rlinf.scheduler.channel.channel_worker import ChannelWorker
...
class DistributedChannel(Channel):
    ...
    def create(
        ...
        """
        from Reinforcement_Learning.RLinf.rlinf.scheduler.channel.channel_worker import LocalChannel
