...
from Reinforcement_Learning.RLinf.rlinf.config import SupportedModel, get_supported_model, torch_dtype_from_precision
from Reinforcement_Learning.RLinf.rlinf.scheduler import Worker


def get_model(cfg: DictConfig):
    model_type = get_supported_model(cfg.model_type)
    if model_type == SupportedModel.OPENVLA:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openvla import get_model
    elif model_type == SupportedModel.OPENVLA_OFT:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openvla_oft import get_model
    elif model_type == SupportedModel.OPENPI:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openpi import get_model
    elif model_type == SupportedModel.DEXBOTIC_PI:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.dexbotic_pi import get_model
    elif model_type == SupportedModel.MLP_POLICY:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.mlp_policy import get_model
    elif model_type == SupportedModel.GR00T:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.gr00t import get_model
    elif model_type == SupportedModel.CNN_POLICY:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.cnn_policy import get_model
    elif model_type == SupportedModel.FLOW_POLICY:
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.flow_policy import get_model
    else:
        return None
