...
from Reinforcement_Learning.RLinf.rlinf.models.embodiment.modules.q_head import MultiCrossQHead, MultiQHead
from Reinforcement_Learning.RLinf.rlinf.models.embodiment.modules.resnet_utils import ResNetEncoder
from Reinforcement_Learning.RLinf.rlinf.models.embodiment.modules.utils import init_mlp_weights, layer_init, make_mlp
...
class CNNPolicy(nn.Module, BasePolicy):
    ...
    def capture_action_generation(
        ...
        from Reinforcement_Learning.RLinf.rlinf.utils.cuda_graph import GraphCaptureSpec
    ...
    def capture_cuda_graph(self, train_batch_size: int, eval_batch_size: int):
        from Reinforcement_Learning.RLinf.rlinf.utils.cuda_graph import CUDAGraphManager
