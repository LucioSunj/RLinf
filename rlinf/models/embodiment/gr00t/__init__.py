...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    from Reinforcement_Learning.RLinf.rlinf.models.embodiment.gr00t.gr00t_action_model import (
        GR00T_N1_5_ForRLActionPrediction,
    )
    from Reinforcement_Learning.RLinf.rlinf.models.embodiment.gr00t.utils import replace_dropout_with_identity
