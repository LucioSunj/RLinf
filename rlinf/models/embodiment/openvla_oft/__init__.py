...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    if implement_version == "rlinf":
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openvla_oft.rlinf import get_model
    elif implement_version == "official":
        from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openvla_oft.official import get_model
    else:
