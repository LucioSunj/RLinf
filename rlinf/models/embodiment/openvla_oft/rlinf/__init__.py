...
def get_model_config_and_input_processor(cfg: DictConfig):
    ...
    from Reinforcement_Learning.RLinf.rlinf.models.embodiment.prismatic.processing_prismatic import (
...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openvla_oft.rlinf.openvla_oft_action_model import (
