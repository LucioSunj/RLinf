...
import Reinforcement_Learning.RLinf.rlinf.algorithms  # noqa: F401
from Reinforcement_Learning.RLinf.rlinf.algorithms.registry import calculate_adv_and_returns, policy_loss
from Reinforcement_Learning.RLinf.rlinf.algorithms.utils import (
    kl_penalty,
)
from Reinforcement_Learning.RLinf.rlinf.config import SupportedModel, torch_dtype_from_precision
from Reinforcement_Learning.RLinf.rlinf.data.embodied_io_struct import Trajectory, convert_trajectories_to_batch
from Reinforcement_Learning.RLinf.rlinf.data.io_struct import BatchResizingIterator, RolloutResult
from Reinforcement_Learning.RLinf.rlinf.hybrid_engines.fsdp.fsdp_model_manager import (
    FSDPModelManager,
)
from Reinforcement_Learning.RLinf.rlinf.hybrid_engines.fsdp.utils import (
    pack_fsdp_input,
    prepare_pack_fsdp,
    unpack_fsdp_logprobs,
    unpack_sequences,
)
from Reinforcement_Learning.RLinf.rlinf.models import get_model
from Reinforcement_Learning.RLinf.rlinf.models.embodiment.base_policy import ForwardType
from Reinforcement_Learning.RLinf.rlinf.scheduler import Channel, Cluster, CollectiveGroupOptions, Worker
from Reinforcement_Learning.RLinf.rlinf.utils.data_iter_utils import (
    get_iterator_k_split,
    get_reverse_idx,
    get_seqlen_balanced_partitions,
    split_dynamic_batch_size,
)
from Reinforcement_Learning.RLinf.rlinf.utils.distributed import (
    RolloutDataBalance,
    all_reduce_dict,
    all_reduce_int,
...
from Reinforcement_Learning.RLinf.rlinf.utils.metric_utils import (
    append_to_dict,
    compute_loss_mask,
    compute_rollout_metrics,
    compute_split_num,
)
from Reinforcement_Learning.RLinf.rlinf.utils.nested_dict_process import (
    put_tensor_device,
    split_dict_to_chunk,
)
from Reinforcement_Learning.RLinf.rlinf.utils.placement import (
    HybridComponentPlacement,
    ModelParallelComponentPlacement,
)
from Reinforcement_Learning.RLinf.rlinf.utils.pytree import register_pytree_dataclasses
from Reinforcement_Learning.RLinf.rlinf.utils.utils import (
    clear_memory,
...
from Reinforcement_Learning.RLinf.rlinf.workers.rollout.utils import RankMapper
...
class EmbodiedFSDPActor(FSDPModelManager, Worker):
    ...
    def _build_sft_data_loader(self):
        if SupportedModel(self.cfg.actor.model.model_type) in [SupportedModel.OPENPI]:
            ...
            from Reinforcement_Learning.RLinf.rlinf.models.embodiment.openpi.dataconfig import get_openpi_config
