...
rollout sync therefore needs only trainable Gate/LoRA/value-head/optional
visual-router parameters and persistent buffers. Building a normal FSDP state dict first would clone the
