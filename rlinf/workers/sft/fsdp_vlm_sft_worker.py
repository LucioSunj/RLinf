...
from Reinforcement_Learning.RLinf.rlinf.hybrid_engines.fsdp.utils import generate_with_kv_cache
...
class FSDPVlmSftWorker(FSDPSftWorker):
    ...
    def build_dataloader(self, data_paths: list[str], eval_dataset: bool = False):
        if SupportedModel(self.cfg.actor.model.model_type) in [
            ...
            from Reinforcement_Learning.RLinf.rlinf.data.datasets import sft_collate_fn
