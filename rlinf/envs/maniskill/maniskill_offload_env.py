...
from Reinforcement_Learning.RLinf.rlinf.envs.maniskill.utils import (
    cleanup_cuda_tensors,
    get_batch_rng_state,
    recursive_to_own,
    set_batch_rng_state,
)
from Reinforcement_Learning.RLinf.rlinf.envs.utils import recursive_to_device
...
def _maniskill_worker_main(
    ...
    from Reinforcement_Learning.RLinf.rlinf.utils.omega_resolver import omegaconf_register
