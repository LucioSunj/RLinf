...
from Reinforcement_Learning.RLinf.rlinf.data.io_struct import RolloutRequest
from Reinforcement_Learning.RLinf.rlinf.scheduler import Channel
from Reinforcement_Learning.RLinf.rlinf.scheduler import WorkerGroupFuncResult as Handle
from Reinforcement_Learning.RLinf.rlinf.utils.data_iter_utils import split_list
from Reinforcement_Learning.RLinf.rlinf.utils.distributed import ScopedTimer
from Reinforcement_Learning.RLinf.rlinf.utils.metric_logger import MetricLogger
from Reinforcement_Learning.RLinf.rlinf.utils.runner_utils import check_progress, local_mkdir_safe
from Reinforcement_Learning.RLinf.rlinf.utils.timers import Timer

if typing.TYPE_CHECKING:
    from Reinforcement_Learning.RLinf.rlinf.scheduler.dynamic_scheduler.scheduler_worker import SchedulerWorker
    from Reinforcement_Learning.RLinf.rlinf.utils.placement import ModelParallelComponentPlacement
    from Reinforcement_Learning.RLinf.rlinf.workers.actor.fsdp_actor_worker import FSDPActor
    from Reinforcement_Learning.RLinf.rlinf.workers.actor.megatron_actor_worker import MegatronActor
    from rlinf.workers.actor.megatron_critic_worker import MegatronCritic
    from Reinforcement_Learning.RLinf.rlinf.workers.inference.fsdp_inference_worker import FSDPInference
    from Reinforcement_Learning.RLinf.rlinf.workers.inference.megatron_inference_worker import (
        MegatronActorInference,
        MegatronCriticInference,
    )
    from Reinforcement_Learning.RLinf.rlinf.workers.reward.reward_worker import RewardWorker
    from Reinforcement_Learning.RLinf.rlinf.workers.rollout.sglang.sglang_worker import SGLangWorker
    from Reinforcement_Learning.RLinf.rlinf.workers.rollout.vllm.vllm_worker import VLLMWorker
...
class ReasoningRunner:
    ...
    def _build_dataloader(self, train_dataset, val_dataset, collate_fn=None):
        ...
        if collate_fn is None:
            from Reinforcement_Learning.RLinf.rlinf.data.datasets import collate_fn
        ...
        if self.cfg.runner.resume_dir is None:
            ...
            for role in ["actor", "critic"]:
                ...
                if (
                    ...
                    from Reinforcement_Learning.RLinf.rlinf.utils.ckpt_convertor.megatron_convertor.convert_hf_to_mg import (
                        convert_hf_to_mg,
                    )
