...
from Reinforcement_Learning.RLinf.rlinf.envs import SupportedEnvType
from Reinforcement_Learning.RLinf.rlinf.scheduler.cluster import Cluster
...
def validate_megatron_cfg(cfg: DictConfig) -> DictConfig:
    ...
    with open_dict(cfg):
        ...
        from Reinforcement_Learning.RLinf.rlinf.hybrid_engines.megatron.megatron_model_manager import HAVE_FUSCO
