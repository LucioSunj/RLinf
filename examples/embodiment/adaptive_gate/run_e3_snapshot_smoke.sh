...
# REQUIRED INPUTS: shared WAM artifacts, PAIRED_TRAIN_MANIFEST, PLUS_FULL_MANIFEST, DEV_TEST_DISJOINT_AUDIT and E2_DECISION.
...
RUN_ARTIFACTS=(
    ...
    "${DEV_TEST_DISJOINT_AUDIT}" "${E2_DECISION}"
)
CMD=(
